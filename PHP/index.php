                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <?php
                            require 'back.php';
                            $db = Database::connect();
                            $statement = $db ->query('SELECT items.id, items.name, items.description, items.price, category.name AS category FROM items LEFT JOIN category ON items.category = category.id ORDER BY items.id DESC');
